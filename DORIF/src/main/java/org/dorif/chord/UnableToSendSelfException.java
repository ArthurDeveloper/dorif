...
public class UnableToSendSelfException extends org.apache.thrift.TException implements org.apache.thrift.TBase<UnableToSendSelfException, UnableToSendSelfException._Fields>, java.io.Serializable, Cloneable, Comparable<UnableToSendSelfException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UnableToSendSelfException");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new UnableToSendSelfExceptionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new UnableToSendSelfExceptionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UnableToSendSelfException.class, metaDataMap);
  }

  public UnableToSendSelfException() {
    this.errNum = 8;

    this.errMsg = "The node was unable to send its data.";
   ...
   */
  public UnableToSendSelfException(UnableToSendSelfException other) {
  ...
  public UnableToSendSelfException deepCopy() {
    return new UnableToSendSelfException(this);
  }
  ...
  public UnableToSendSelfException setErrNum(int errNum) {
    this.errNum = errNum;
    setErrNumIsSet(true);
    return this;
  }
  ...
  public UnableToSendSelfException setErrMsg(java.lang.String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof UnableToSendSelfException)
      return this.equals((UnableToSendSelfException)that);
    return false;
  }

  public boolean equals(UnableToSendSelfException that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(UnableToSendSelfException other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("UnableToSendSelfException(");
    boolean first = true;
  ...
  private static class UnableToSendSelfExceptionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UnableToSendSelfExceptionStandardScheme getScheme() {
      return new UnableToSendSelfExceptionStandardScheme();
    }
  }

  private static class UnableToSendSelfExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<UnableToSendSelfException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UnableToSendSelfException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UnableToSendSelfException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class UnableToSendSelfExceptionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UnableToSendSelfExceptionTupleScheme getScheme() {
      return new UnableToSendSelfExceptionTupleScheme();
    }
  }

  private static class UnableToSendSelfExceptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<UnableToSendSelfException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UnableToSendSelfException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UnableToSendSelfException struct) throws org.apache.thrift.TException {
