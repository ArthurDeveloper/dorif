...
public class DocumentNotFoundException extends org.apache.thrift.TException implements org.apache.thrift.TBase<DocumentNotFoundException, DocumentNotFoundException._Fields>, java.io.Serializable, Cloneable, Comparable<DocumentNotFoundException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("DocumentNotFoundException");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new DocumentNotFoundExceptionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new DocumentNotFoundExceptionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(DocumentNotFoundException.class, metaDataMap);
  }

  public DocumentNotFoundException() {
    this.errNum = 101;

    this.errMsg = "Required document was not found.";
   ...
   */
  public DocumentNotFoundException(DocumentNotFoundException other) {
  ...
  public DocumentNotFoundException deepCopy() {
    return new DocumentNotFoundException(this);
  }
  ...
  public DocumentNotFoundException setErrNum(int errNum) {
    this.errNum = errNum;
    setErrNumIsSet(true);
    return this;
  }
  ...
  public DocumentNotFoundException setErrMsg(java.lang.String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof DocumentNotFoundException)
      return this.equals((DocumentNotFoundException)that);
    return false;
  }

  public boolean equals(DocumentNotFoundException that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(DocumentNotFoundException other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("DocumentNotFoundException(");
    boolean first = true;
  ...
  private static class DocumentNotFoundExceptionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DocumentNotFoundExceptionStandardScheme getScheme() {
      return new DocumentNotFoundExceptionStandardScheme();
    }
  }

  private static class DocumentNotFoundExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<DocumentNotFoundException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, DocumentNotFoundException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, DocumentNotFoundException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class DocumentNotFoundExceptionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public DocumentNotFoundExceptionTupleScheme getScheme() {
      return new DocumentNotFoundExceptionTupleScheme();
    }
  }

  private static class DocumentNotFoundExceptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<DocumentNotFoundException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, DocumentNotFoundException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, DocumentNotFoundException struct) throws org.apache.thrift.TException {
