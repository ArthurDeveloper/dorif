...
@javax.annotation.Generated(value = "Autogenerated by Thrift Compiler (0.11.0)", date = "2018-10-22")
public class GenericTermInfo implements org.apache.thrift.TBase<GenericTermInfo, GenericTermInfo._Fields>, java.io.Serializable, Cloneable, Comparable<GenericTermInfo> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("GenericTermInfo");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new GenericTermInfoStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new GenericTermInfoTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(GenericTermInfo.class, metaDataMap);
  }

  public GenericTermInfo() {
  }
   ...
   */
  public GenericTermInfo(GenericTermInfo other) {
  ...
  public GenericTermInfo deepCopy() {
    return new GenericTermInfo(this);
  }
  ...
  public GenericTermInfo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public GenericTermInfo setTerm(java.lang.String term) {
    this.term = term;
    return this;
  }
  ...
  public GenericTermInfo setFrequency(long frequency) {
    this.frequency = frequency;
    setFrequencyIsSet(true);
    return this;
  }
  ...
  public GenericTermInfo setIdf(double idf) {
    this.idf = idf;
    setIdfIsSet(true);
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof GenericTermInfo)
      return this.equals((GenericTermInfo)that);
    return false;
  }

  public boolean equals(GenericTermInfo that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(GenericTermInfo other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("GenericTermInfo(");
    boolean first = true;
  ...
  private static class GenericTermInfoStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GenericTermInfoStandardScheme getScheme() {
      return new GenericTermInfoStandardScheme();
    }
  }

  private static class GenericTermInfoStandardScheme extends org.apache.thrift.scheme.StandardScheme<GenericTermInfo> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, GenericTermInfo struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GenericTermInfo struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class GenericTermInfoTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public GenericTermInfoTupleScheme getScheme() {
      return new GenericTermInfoTupleScheme();
    }
  }

  private static class GenericTermInfoTupleScheme extends org.apache.thrift.scheme.TupleScheme<GenericTermInfo> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, GenericTermInfo struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, GenericTermInfo struct) throws org.apache.thrift.TException {
