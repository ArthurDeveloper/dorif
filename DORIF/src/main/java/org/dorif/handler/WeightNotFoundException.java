...
public class WeightNotFoundException extends org.apache.thrift.TException implements org.apache.thrift.TBase<WeightNotFoundException, WeightNotFoundException._Fields>, java.io.Serializable, Cloneable, Comparable<WeightNotFoundException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("WeightNotFoundException");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new WeightNotFoundExceptionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new WeightNotFoundExceptionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(WeightNotFoundException.class, metaDataMap);
  }

  public WeightNotFoundException() {
    this.errNum = 105;

    this.errMsg = "Requested weight was not found.";
   ...
   */
  public WeightNotFoundException(WeightNotFoundException other) {
  ...
  public WeightNotFoundException deepCopy() {
    return new WeightNotFoundException(this);
  }
  ...
  public WeightNotFoundException setErrNum(int errNum) {
    this.errNum = errNum;
    setErrNumIsSet(true);
    return this;
  }
  ...
  public WeightNotFoundException setErrMsg(java.lang.String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof WeightNotFoundException)
      return this.equals((WeightNotFoundException)that);
    return false;
  }

  public boolean equals(WeightNotFoundException that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(WeightNotFoundException other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("WeightNotFoundException(");
    boolean first = true;
  ...
  private static class WeightNotFoundExceptionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public WeightNotFoundExceptionStandardScheme getScheme() {
      return new WeightNotFoundExceptionStandardScheme();
    }
  }

  private static class WeightNotFoundExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<WeightNotFoundException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, WeightNotFoundException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WeightNotFoundException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class WeightNotFoundExceptionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public WeightNotFoundExceptionTupleScheme getScheme() {
      return new WeightNotFoundExceptionTupleScheme();
    }
  }

  private static class WeightNotFoundExceptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<WeightNotFoundException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, WeightNotFoundException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, WeightNotFoundException struct) throws org.apache.thrift.TException {
