...
public class TermNotFoundException extends org.apache.thrift.TException implements org.apache.thrift.TBase<TermNotFoundException, TermNotFoundException._Fields>, java.io.Serializable, Cloneable, Comparable<TermNotFoundException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TermNotFoundException");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TermNotFoundExceptionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TermNotFoundExceptionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TermNotFoundException.class, metaDataMap);
  }

  public TermNotFoundException() {
    this.errNum = 103;

    this.errMsg = "Requested term was not found.";
   ...
   */
  public TermNotFoundException(TermNotFoundException other) {
  ...
  public TermNotFoundException deepCopy() {
    return new TermNotFoundException(this);
  }
  ...
  public TermNotFoundException setErrNum(int errNum) {
    this.errNum = errNum;
    setErrNumIsSet(true);
    return this;
  }
  ...
  public TermNotFoundException setErrMsg(java.lang.String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TermNotFoundException)
      return this.equals((TermNotFoundException)that);
    return false;
  }

  public boolean equals(TermNotFoundException that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TermNotFoundException other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TermNotFoundException(");
    boolean first = true;
  ...
  private static class TermNotFoundExceptionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TermNotFoundExceptionStandardScheme getScheme() {
      return new TermNotFoundExceptionStandardScheme();
    }
  }

  private static class TermNotFoundExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<TermNotFoundException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TermNotFoundException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TermNotFoundException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TermNotFoundExceptionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TermNotFoundExceptionTupleScheme getScheme() {
      return new TermNotFoundExceptionTupleScheme();
    }
  }

  private static class TermNotFoundExceptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<TermNotFoundException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TermNotFoundException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TermNotFoundException struct) throws org.apache.thrift.TException {
