...
public class UnableToFixFingerException extends org.apache.thrift.TException implements org.apache.thrift.TBase<UnableToFixFingerException, UnableToFixFingerException._Fields>, java.io.Serializable, Cloneable, Comparable<UnableToFixFingerException> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("UnableToFixFingerException");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new UnableToFixFingerExceptionStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new UnableToFixFingerExceptionTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(UnableToFixFingerException.class, metaDataMap);
  }

  public UnableToFixFingerException() {
    this.errNum = 7;

    this.errMsg = "An error occurred while refreshing the finger table.";
   ...
   */
  public UnableToFixFingerException(UnableToFixFingerException other) {
  ...
  public UnableToFixFingerException deepCopy() {
    return new UnableToFixFingerException(this);
  }
  ...
  public UnableToFixFingerException setErrNum(int errNum) {
    this.errNum = errNum;
    setErrNumIsSet(true);
    return this;
  }
  ...
  public UnableToFixFingerException setErrMsg(java.lang.String errMsg) {
    this.errMsg = errMsg;
    return this;
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof UnableToFixFingerException)
      return this.equals((UnableToFixFingerException)that);
    return false;
  }

  public boolean equals(UnableToFixFingerException that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(UnableToFixFingerException other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("UnableToFixFingerException(");
    boolean first = true;
  ...
  private static class UnableToFixFingerExceptionStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UnableToFixFingerExceptionStandardScheme getScheme() {
      return new UnableToFixFingerExceptionStandardScheme();
    }
  }

  private static class UnableToFixFingerExceptionStandardScheme extends org.apache.thrift.scheme.StandardScheme<UnableToFixFingerException> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, UnableToFixFingerException struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, UnableToFixFingerException struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class UnableToFixFingerExceptionTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public UnableToFixFingerExceptionTupleScheme getScheme() {
      return new UnableToFixFingerExceptionTupleScheme();
    }
  }

  private static class UnableToFixFingerExceptionTupleScheme extends org.apache.thrift.scheme.TupleScheme<UnableToFixFingerException> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, UnableToFixFingerException struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, UnableToFixFingerException struct) throws org.apache.thrift.TException {
